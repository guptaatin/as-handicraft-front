                    ...
                    <Row>
                        ...
                        <Col xs={24} sm={20} md={20} lg={20} xl={20}>
                            <div style={{ maxWidth: 1000, marginLeft: 'auto', marginTop: 64 }}>
                                <Carousell
                                    show={window.innerWidth > 800 ? 4 : 2}
                                >
                                    <div>
                                        <Card
                                            style={{ width: 300 }}
